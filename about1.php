...
<body>
    ...
    <section id="page-header"  class="about-header">
        <h2>#KnowUs</h2>
        <p>Know more about us, Know more about Lusso.</p>
    </section>
    ...
    <section id="about-head" class="section-p1">
        ...
        <div>
            <h2>Who We Are?</h2>
            <p>We believe that Fashion sense and Clothing sense is improved day by dayand it will never go out of life, therefore we want to give everyone the oppertunity to become apart of the latest trends and fashion wear while providing clothing that not only feels good, but looks good as well. The Spanish word 'Lusso' that means 'Luxurious'. We want Lusso to represent high quality clothing and accessories. Limited and featured clothing drops will express our true creativity for our audience to enjoy and participate in. Lusso is a clothing brand created by our team.</p>
            <p>From, </p>
            <abbr title=""> <p>Lusso, Since- 2022.</p></abbr>
            <br><br>
            <marquee bgcolor="#ccc" loop="-1" scrollamount="5" width="100%"> <p>Lusso is now in India !! Checkout our latest collections in our Website.</p></marquee>
        </div>
    </section>
    <section id="about-app" class="section-p1">
        <h1>Download Our <a href ="#">App</a> Lusso from<br><a href ="#"> Play Store</a> & <a href ="#">App Store</a></h1>
        <div class="video">
